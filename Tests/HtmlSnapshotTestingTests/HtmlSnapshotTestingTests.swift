          ...
          .header(
            ...
            .nav(
              .div(
                ...
                .a(
                  attributes: [.href("/")],
                  .img(base64: "ZnVuY3Rpb25z", type: .image(.svg), alt: "", attributes: [.class("hide-d")])
                )
              ),
              .div(
                attributes: [.class("col-m")],
                .div(
                  ...
                  .div(
                    ...
                    .a(
                      attributes: [.href("/")],
                      .img(base64: "ZnVuY3Rpb25z", type: .image(.svg), alt: "", attributes: [.class("hide-m")])
                    )
                  )
                )
              ),
                      ...
                      .div(
                        ...
                        .div(
                          ...
                          .label(
                            ...
                            .div(
                              attributes: [.style(safe: "flex-direction:column-reverse"), .class("row")],
                              .input(
                                attributes: [
                                  .checked(true),
                                  .id("monthly"),
